...
SITE_ROOT = "/"
SITE_WWW_URL = "http://jairtrejo.mx"
SITE_NAME = "Jair Trejo"
SITE_AUTHOR = "Jair Trejo"
...
# Starting under the media folder. For example, if you have media/css
# under your site root,you should specify just css. If you have
# media/css/ie you should specify css/ie for the folder name. css/* is
# not supported (yet).
...
MEDIA_PROCESSORS = {
    '*': {
        ...
        '.hss': ('hydeengine.media_processors.TemplateProcessor',
...
CONTENT_PROCESSORS = {
    '*': {
        'favicon.ico': ('hydeengine.content_processors.PassthroughProcessor',)
        }
    }
